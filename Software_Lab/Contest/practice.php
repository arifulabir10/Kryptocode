    ...
    <div class="main">
        ...
        while( $rows = mysqli_fetch_array( $results ) ){
            ...
            echo'<div class="description">';
                echo"<p><h4>Enhance your skills by practicing <h2 style='color:orangered'>$certify_title</h2></h4></p>";
            echo'</div>';
            
                echo"<a href='../xcode-main/index.html'> <button class='button'> Practice Now</button> </a>";
